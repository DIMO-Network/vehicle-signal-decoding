...
INSERT INTO pid_configs (template_name, pid, formula, interval_seconds, protocol, signal_name)
VALUES ('default-ice-can11', E'\\x67', 'dbc: 31|8@0+ (1,-40) [-40|215] "Celcius"', 30, 'CAN11_500', 'coolantTemp');
...
INSERT INTO pid_configs (header, template_name, pid, formula, interval_seconds, protocol, signal_name)
VALUES (E'\\x18DB33F1', 'default-ice-can29', E'\\x67', 'dbc: 31|8@0+ (1,-40) [-40|215] "Celcius"', 30, 'CAN29_500', 'coolantTemp');
