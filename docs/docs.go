// Package docs Code generated by swaggo/swag at 2025-01-22 14:56:01.420447 -0500 EST m=+0.970447376. DO NOT EDIT
package docs
...
const docTemplate = `{
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_controllers.DeviceRuptelaStatusPatch"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_controllers.DeviceRuptelaStatusPatch": {
            "type": "object",
            "properties": {
                "accessTech": {
                    "description": "ignored, it is only used to validate the signature and authenticate the device",
                    "type": "string"
                },
                "battVolt": {
                    "description": "ignored, it is only used to validate the signature and authenticate the device",
                ...
                "fwVersion": {
                    "description": "FwVersion version of firmware that was confirmed installed on device",
                    "type": "string"
                },
                "hwVersion": {
                    "description": "ignored, it is only used to validate the signature and authenticate the device",
