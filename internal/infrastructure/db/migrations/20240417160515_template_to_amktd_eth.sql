...
CREATE TABLE IF NOT EXISTS aftermarket_device_to_template_overrides (
  aftermarket_device_ethereum_address bytea NOT NULL,
  template_name TEXT NOT NULL,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,

  CONSTRAINT serial_to_template_overrides_pkey PRIMARY KEY (aftermarket_device_ethereum_address, template_name)
);
-- +goose StatementEnd
...
DROP TABLE IF EXISTS aftermarket_device_to_template_overrides CASCADE;
-- +goose StatementEnd
