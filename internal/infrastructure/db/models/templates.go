...
func (r *templateR) GetTemplateDBCURLDeviceTemplateStatuses() DeviceTemplateStatusSlice {
	if r == nil {
		return nil
	}
	return r.TemplateDBCURLDeviceTemplateStatuses
}

func (r *templateR) GetTemplatePidURLDeviceTemplateStatuses() DeviceTemplateStatusSlice {
	if r == nil {
		return nil
	}
...
// TemplateDBCURLDeviceTemplateStatuses retrieves all the device_template_status's DeviceTemplateStatuses with an executor via template_dbc_url column.
func (o *Template) TemplateDBCURLDeviceTemplateStatuses(mods ...qm.QueryMod) deviceTemplateStatusQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"vehicle_signal_decoding_api\".\"device_template_status\".\"template_dbc_url\"=?", o.TemplateName),
	)

	return DeviceTemplateStatuses(queryMods...)
}

// TemplatePidURLDeviceTemplateStatuses retrieves all the device_template_status's DeviceTemplateStatuses with an executor via template_pid_url column.
func (o *Template) TemplatePidURLDeviceTemplateStatuses(mods ...qm.QueryMod) deviceTemplateStatusQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"vehicle_signal_decoding_api\".\"device_template_status\".\"template_pid_url\"=?", o.TemplateName),
	)
...
// LoadTemplateDBCURLDeviceTemplateStatuses allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (templateL) LoadTemplateDBCURLDeviceTemplateStatuses(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTemplate interface{}, mods queries.Applicator) error {
	var slice []*Template
	var object *Template
	...
	query := NewQuery(
		...
		qm.WhereIn(`vehicle_signal_decoding_api.device_template_status.template_dbc_url in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load device_template_status")
	}

	var resultSlice []*DeviceTemplateStatus
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice device_template_status")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on device_template_status")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for device_template_status")
	}
	...
	if singular {
		object.R.TemplateDBCURLDeviceTemplateStatuses = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.TemplateName == foreign.TemplateDBCURL {
				local.R.TemplateDBCURLDeviceTemplateStatuses = append(local.R.TemplateDBCURLDeviceTemplateStatuses, foreign)
				if foreign.R == nil {
					foreign.R = &deviceTemplateStatusR{}
				}
...
// LoadTemplatePidURLDeviceTemplateStatuses allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (templateL) LoadTemplatePidURLDeviceTemplateStatuses(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTemplate interface{}, mods queries.Applicator) error {
	var slice []*Template
	var object *Template
	...
	query := NewQuery(
		qm.From(`vehicle_signal_decoding_api.device_template_status`),
		qm.WhereIn(`vehicle_signal_decoding_api.device_template_status.template_pid_url in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.TemplatePidURLDeviceTemplateStatuses = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &deviceTemplateStatusR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.TemplateName == foreign.TemplatePidURL {
				local.R.TemplatePidURLDeviceTemplateStatuses = append(local.R.TemplatePidURLDeviceTemplateStatuses, foreign)
				if foreign.R == nil {
					foreign.R = &deviceTemplateStatusR{}
				}
...
// AddTemplateDBCURLDeviceTemplateStatuses adds the given related objects to the existing relationships
// of the template, optionally inserting them as new records.
// Appends related to o.R.TemplateDBCURLDeviceTemplateStatuses.
// Sets related.R.TemplateDBCURLTemplate appropriately.
func (o *Template) AddTemplateDBCURLDeviceTemplateStatuses(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*DeviceTemplateStatus) error {
	var err error
	for _, rel := range related {
		if insert {
	...
	if o.R == nil {
		o.R = &templateR{
			TemplateDBCURLDeviceTemplateStatuses: related,
		}
	} else {
		o.R.TemplateDBCURLDeviceTemplateStatuses = append(o.R.TemplateDBCURLDeviceTemplateStatuses, related...)
	}
...
// AddTemplatePidURLDeviceTemplateStatuses adds the given related objects to the existing relationships
// of the template, optionally inserting them as new records.
// Appends related to o.R.TemplatePidURLDeviceTemplateStatuses.
// Sets related.R.TemplatePidURLTemplate appropriately.
func (o *Template) AddTemplatePidURLDeviceTemplateStatuses(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*DeviceTemplateStatus) error {
	var err error
	for _, rel := range related {
		if insert {
	...
	if o.R == nil {
		o.R = &templateR{
			TemplatePidURLDeviceTemplateStatuses: related,
		}
	} else {
		o.R.TemplatePidURLDeviceTemplateStatuses = append(o.R.TemplatePidURLDeviceTemplateStatuses, related...)
	}
