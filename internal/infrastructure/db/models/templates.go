...
func (o *Template) GetTemplateNameDBCFile() *DBCFile {
	if o == nil {
		return nil
	}

	return o.R.GetTemplateNameDBCFile()
}
...
func (o *Template) GetTemplateNameAftermarketDeviceToTemplates() AftermarketDeviceToTemplateSlice {
	if o == nil {
		return nil
	}

	return o.R.GetTemplateNameAftermarketDeviceToTemplates()
}
...
func (o *Template) GetTemplateNameDeviceSettings() DeviceSettingSlice {
	if o == nil {
		return nil
	}

	return o.R.GetTemplateNameDeviceSettings()
}
...
func (o *Template) GetTemplateNamePidConfigs() PidConfigSlice {
	if o == nil {
		return nil
	}

	return o.R.GetTemplateNamePidConfigs()
}
...
func (o *Template) GetTemplateNameTemplateDeviceDefinitions() TemplateDeviceDefinitionSlice {
	if o == nil {
		return nil
	}

	return o.R.GetTemplateNameTemplateDeviceDefinitions()
}
...
func (o *Template) GetTemplateNameTemplateVehicles() TemplateVehicleSlice {
	if o == nil {
		return nil
	}

	return o.R.GetTemplateNameTemplateVehicles()
}
...
func (templateL) LoadTemplateNameDBCFile(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTemplate interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`vehicle_signal_decoding_api.dbc_files.template_name in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (templateL) LoadTemplateNameDeviceSettings(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTemplate interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`vehicle_signal_decoding_api.device_settings.template_name in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (templateL) LoadTemplateNamePidConfigs(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTemplate interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`vehicle_signal_decoding_api.pid_configs.template_name in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (templateL) LoadTemplateNameTemplateDeviceDefinitions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTemplate interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`vehicle_signal_decoding_api.template_device_definitions.template_name in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (templateL) LoadTemplateNameTemplateVehicles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTemplate interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`vehicle_signal_decoding_api.template_vehicles.template_name in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
