...
func (o *DBCCode) GetTestSignals() TestSignalSlice {
	if o == nil {
		return nil
	}

	return o.R.GetTestSignals()
}
...
var dbcCodeAfterSelectMu sync.Mutex
var dbcCodeAfterSelectHooks []DBCCodeHook

var dbcCodeBeforeInsertMu sync.Mutex
var dbcCodeBeforeInsertHooks []DBCCodeHook
var dbcCodeAfterInsertMu sync.Mutex
var dbcCodeAfterInsertHooks []DBCCodeHook

var dbcCodeBeforeUpdateMu sync.Mutex
var dbcCodeBeforeUpdateHooks []DBCCodeHook
var dbcCodeAfterUpdateMu sync.Mutex
var dbcCodeAfterUpdateHooks []DBCCodeHook

var dbcCodeBeforeDeleteMu sync.Mutex
var dbcCodeBeforeDeleteHooks []DBCCodeHook
var dbcCodeAfterDeleteMu sync.Mutex
var dbcCodeAfterDeleteHooks []DBCCodeHook

var dbcCodeBeforeUpsertMu sync.Mutex
var dbcCodeBeforeUpsertHooks []DBCCodeHook
var dbcCodeAfterUpsertMu sync.Mutex
...
func (dbcCodeL) LoadTestSignals(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDBCCode interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`vehicle_signal_decoding_api.test_signals.dbc_codes_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *DBCCode) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return DBCCodeExists(ctx, exec, o.ID)
}
