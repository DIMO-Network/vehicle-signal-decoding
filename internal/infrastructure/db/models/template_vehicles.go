...
func (o *TemplateVehicle) SetTemplateNameTemplate(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Template) error {
	...
	values := []interface{}{related.TemplateName, o.MakeSlug, o.YearStart, o.YearEnd}
...
func FindTemplateVehicle(ctx context.Context, exec boil.ContextExecutor, makeSlug string, yearStart int, yearEnd int, selectCols ...string) (*TemplateVehicle, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"vehicle_signal_decoding_api\".\"template_vehicles\" where \"make_slug\"=$1 AND \"year_start\"=$2 AND \"year_end\"=$3", sel,
	)

	q := queries.Raw(query, makeSlug, yearStart, yearEnd)
...
func (o *TemplateVehicle) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"vehicle_signal_decoding_api\".\"template_vehicles\" WHERE \"make_slug\"=$1 AND \"year_start\"=$2 AND \"year_end\"=$3"
...
func (o *TemplateVehicle) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindTemplateVehicle(ctx, exec, o.MakeSlug, o.YearStart, o.YearEnd)
	if err != nil {
		return err
	}
...
func TemplateVehicleExists(ctx context.Context, exec boil.ContextExecutor, makeSlug string, yearStart int, yearEnd int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"vehicle_signal_decoding_api\".\"template_vehicles\" where \"make_slug\"=$1 AND \"year_start\"=$2 AND \"year_end\"=$3 limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, makeSlug, yearStart, yearEnd)
	}
	row := exec.QueryRowContext(ctx, sql, makeSlug, yearStart, yearEnd)
...
func (o *TemplateVehicle) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return TemplateVehicleExists(ctx, exec, o.MakeSlug, o.YearStart, o.YearEnd)
}
