...
func (o *TemplateVehicle) GetTemplateNameTemplate() *Template {
	if o == nil {
		return nil
	}
...
func (o *TemplateVehicle) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return TemplateVehicleExists(ctx, exec, o.ID)
}
