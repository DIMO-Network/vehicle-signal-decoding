...
func (m *MockDeviceTemplateService) ResolveDeviceConfiguration(ctx context.Context, ud *grpc.UserDevice, vehicle *gateways.VehicleInfo, ethAddress common.Address) (*appmodels.DeviceConfigResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ResolveDeviceConfiguration", ctx, ud, vehicle, ethAddress)
...
func (mr *MockDeviceTemplateServiceMockRecorder) ResolveDeviceConfiguration(ctx, ud, vehicle, ethAddress interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ResolveDeviceConfiguration", reflect.TypeOf((*MockDeviceTemplateService)(nil).ResolveDeviceConfiguration), ctx, ud, vehicle, ethAddress)
}
...
func (mr *MockDeviceTemplateServiceMockRecorder) StoreDeviceConfigUsed(ctx, address, dbcURL, pidURL, settingURL, firmwareVersion interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
