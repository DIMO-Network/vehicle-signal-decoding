...
var file_pkg_grpc_vehicle_template_proto_rawDesc = []byte{
	...
	0x90, 0x02, 0x0a, 0x16, 0x56, 0x65, 0x68, 0x69, 0x63, 0x6c, 0x65, 0x54, 0x65, 0x6d, 0x70, 0x6c,
...
var file_pkg_grpc_vehicle_template_proto_depIdxs = []int32{
	...
	2, // 4: grpc.VehicleTemplateService.GetVehicleTemplates:output_type -> grpc.GetVehicleTemplatesResponse
	0, // 5: grpc.VehicleTemplateService.GetVehicleTemplate:output_type -> grpc.VehicleTemplate
	4, // 6: grpc.VehicleTemplateService.CreateVehicleTemplate:output_type -> google.protobuf.Empty
