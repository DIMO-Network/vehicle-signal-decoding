...
func (c *aftermarketDeviceTemplateServiceClient) CreateAftermarketDeviceTemplate(ctx context.Context, in *AftermarketDeviceTemplateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.AftermarketDeviceTemplateService/CreateAftermarketDeviceTemplate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aftermarketDeviceTemplateServiceClient) DeleteAftermarketDeviceTemplate(ctx context.Context, in *AftermarketDeviceTemplateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/grpc.AftermarketDeviceTemplateService/DeleteAftermarketDeviceTemplate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aftermarketDeviceTemplateServiceClient) GetAftermarketDeviceTemplates(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AftermarketDeviceTemplates, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.AftermarketDeviceTemplateService/GetAftermarketDeviceTemplates", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aftermarketDeviceTemplateServiceClient) GetAftermarketDeviceTemplate(ctx context.Context, in *AftermarketDeviceTemplateRequest, opts ...grpc.CallOption) (*AftermarketDeviceTemplate, error) {
	out := new(AftermarketDeviceTemplate)
	err := c.cc.Invoke(ctx, "/grpc.AftermarketDeviceTemplateService/GetAftermarketDeviceTemplate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAftermarketDeviceTemplateServiceServer) GetAftermarketDeviceTemplate(context.Context, *AftermarketDeviceTemplateRequest) (*AftermarketDeviceTemplate, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAftermarketDeviceTemplate not implemented")
}
...
func _AftermarketDeviceTemplateService_CreateAftermarketDeviceTemplate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.AftermarketDeviceTemplateService/CreateAftermarketDeviceTemplate",
	}
...
func _AftermarketDeviceTemplateService_DeleteAftermarketDeviceTemplate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.AftermarketDeviceTemplateService/DeleteAftermarketDeviceTemplate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AftermarketDeviceTemplateService_GetAftermarketDeviceTemplates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.AftermarketDeviceTemplateService/GetAftermarketDeviceTemplates",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AftermarketDeviceTemplateService_GetAftermarketDeviceTemplate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AftermarketDeviceTemplateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AftermarketDeviceTemplateServiceServer).GetAftermarketDeviceTemplate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.AftermarketDeviceTemplateService/GetAftermarketDeviceTemplate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AftermarketDeviceTemplateServiceServer).GetAftermarketDeviceTemplate(ctx, req.(*AftermarketDeviceTemplateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
