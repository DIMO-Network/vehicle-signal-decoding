...
type VehicleSignalDecodingServiceClient interface {
	...
	GetDeviceTemplateStatusByEtherumAddress(ctx context.Context, in *GetDeviceTemplateStatusByEtherumAddressRequest, opts ...grpc.CallOption) (*GetDeviceTemplateStatusResponse, error)
}
...
func (c *vehicleSignalDecodingServiceClient) GetCanBusDumpFiles(ctx context.Context, in *GetCanBusDumpFileRequest, opts ...grpc.CallOption) (*GetCanBusDumpFileResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.VehicleSignalDecodingService/GetCanBusDumpFiles", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vehicleSignalDecodingServiceClient) DownloadCanBusDumpFile(ctx context.Context, in *DownloadCanBusDumpFileContentRequest, opts ...grpc.CallOption) (*DownloadCanBusDumpFileContentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.VehicleSignalDecodingService/DownloadCanBusDumpFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vehicleSignalDecodingServiceClient) GetDeviceTemplateStatusByEtherumAddress(ctx context.Context, in *GetDeviceTemplateStatusByEtherumAddressRequest, opts ...grpc.CallOption) (*GetDeviceTemplateStatusResponse, error) {
	out := new(GetDeviceTemplateStatusResponse)
	err := c.cc.Invoke(ctx, "/grpc.VehicleSignalDecodingService/GetDeviceTemplateStatusByEtherumAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VehicleSignalDecodingServiceServer interface {
	...
	GetDeviceTemplateStatusByEtherumAddress(context.Context, *GetDeviceTemplateStatusByEtherumAddressRequest) (*GetDeviceTemplateStatusResponse, error)
...
func (UnimplementedVehicleSignalDecodingServiceServer) GetDeviceTemplateStatusByEtherumAddress(context.Context, *GetDeviceTemplateStatusByEtherumAddressRequest) (*GetDeviceTemplateStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDeviceTemplateStatusByEtherumAddress not implemented")
}
...
func _VehicleSignalDecodingService_GetCanBusDumpFiles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.VehicleSignalDecodingService/GetCanBusDumpFiles",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VehicleSignalDecodingService_DownloadCanBusDumpFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.VehicleSignalDecodingService/DownloadCanBusDumpFile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VehicleSignalDecodingService_GetDeviceTemplateStatusByEtherumAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDeviceTemplateStatusByEtherumAddressRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VehicleSignalDecodingServiceServer).GetDeviceTemplateStatusByEtherumAddress(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.VehicleSignalDecodingService/GetDeviceTemplateStatusByEtherumAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VehicleSignalDecodingServiceServer).GetDeviceTemplateStatusByEtherumAddress(ctx, req.(*GetDeviceTemplateStatusByEtherumAddressRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VehicleSignalDecodingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetDeviceTemplateStatusByEtherumAddress",
			Handler:    _VehicleSignalDecodingService_GetDeviceTemplateStatusByEtherumAddress_Handler,
		},
	},
