...
const (
	...
	VehicleSignalDecodingService_GetDeviceTemplateStatusByEtherumAddress_FullMethodName = "/grpc.VehicleSignalDecodingService/GetDeviceTemplateStatusByEtherumAddress"
)
...
func (c *vehicleSignalDecodingServiceClient) GetDeviceTemplateStatusByEtherumAddress(ctx context.Context, in *GetDeviceTemplateStatusByEtherumAddressRequest, opts ...grpc.CallOption) (*GetDeviceTemplateStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, VehicleSignalDecodingService_GetDeviceTemplateStatusByEtherumAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _VehicleSignalDecodingService_GetDeviceTemplateStatusByEtherumAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VehicleSignalDecodingService_GetDeviceTemplateStatusByEtherumAddress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
